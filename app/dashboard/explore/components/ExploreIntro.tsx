...
function Intro({
  ...
  return (
    <>
      <h3 className="hidden text-[33px] font-[600]">Hello Fancy</h3>
      ...
      <div className="bg-[#9A4FFF]/[10%] rounded-[7px] mt-12 w-full">
        <p className="text-center text-[19px] p-4">
          ...
          teaching strategies, I&apos;ve got you covered!
        </p>
      </div>

      <div className="grid grid-cols-1 place-items-center md:grid-cols-2 gap-10 mt-7 cursor-pointer">
