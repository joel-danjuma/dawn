...
NEVER start your response with an introduction in the form of a greeting or any other text eg "Here is a rewritten version of the input text:".
...
Please ensure the rewritten text is free of grammatical errors, typos, and punctuation issues . 
`,
