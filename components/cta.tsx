...
const Cta = () => {
  return (
    <section id="cta" className="p-4 relative">
      <div className="absolute -top-[140px] -left-[80px] z-0 lg:flex hidden">
        <Image src={img1} alt="img1" width={428} height={428}/>
      </div>
      <div className="absolute -top-[220px] -right-[120px] z-0 lg:flex hidden">
      ...
      <div className="absolute -bottom-12 right-48 z-0 lg:flex hidden">
